...
/**
 * A search field component that calls the SWDirectAction.search() Direct action
 * with the correct arguments.
 */

public class SWSearchField extends SWGenericComponent {

	public SWSearchField( WOContext context ) {
		super( context );
	}
