...
import concept.components.admin.edit.CPEditComponent;
...
import concept.components.admin.edit.CPEditPage;
import concept.components.admin.edit.CPEditSite;
...
public class SystemDefinitions implements ProvidesEntityViewDefinitions{
	...
	public NSArray<EntityViewDefinition> entityViewDefinitions() {
		...
		a.add( EntityViewDefinition.create( SWComponent.ENTITY_NAME, "Efni", "Efni", "Kerfi", null, null, null, false, null, CPEditComponent.class ) );
		...
		a.add( EntityViewDefinition.create( SWPage.ENTITY_NAME, "Vefsíða", "Vefsíður", "Kerfi", null, "page", null, false, SWPageDetailPage.class, CPEditPage.class ) );
		a.add( EntityViewDefinition.create( SWSite.ENTITY_NAME, "Vefur", "Vefir", "Kerfi", null, null, null, false, null, CPEditSite.class ) );
